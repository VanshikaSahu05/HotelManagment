...
const AllRooms = () => {
  ...
  return (
    <div className="flex flex-col-reverse gap-10 lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32">
      <div>
      ...
      <div className="bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 lg:mt-16 ">
        <div
          className={`flex items-center justify-between px-5 py-2.5 border-b border-gray-300 lg:border-b ${openFilter && "border-b"}`}
        >
